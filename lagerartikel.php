        ...
        <div class="collapse navbar-collapse" id="defaultNavbar1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="day.php">Täglich</a></li>
                ...
                <li class="active"><a href="lagerartikel.php">Lager/Artikel</a></li> 
...
<table class="tbl-qa">
  <thead>
	<tr>
	  <th class="table-header" width="5%"><div style="text-align:right;"><a href="add_la.php" class="button_link"><img src="crud-icon/add.png" title="Add New Record" style="vertical-align:bottom;" />Add</a></div ></th>
      <th class="table-header" width="20%">Lager</th>
      <th class="table-header" width="30%">Artikel</th>
	  <th class="table-header" width="5%">Anzahl</th>        
      <th class="table-header" width="5%">Price</th>
  ...
  <tbody id="table-body">
	...
	?>
	  <tr class="table-row">
        ...
        <td><?php echo $row["lagerartikel_id"]; ?></td>
        <td><?php echo $row["name_lager"]; ?></td>
        <td><?php echo $row["name_artikel"]; ?></td>  
        <td><?php echo $row["anzahl"]; ?></td>
        <td><?php echo $row["price"]; ?></td>
        <td><?php echo date_format(date_create($row["date_lagerartikel"]),"d.m.Y"); ?></td> 
          

         
         
	<td>
		<a href='edit_la.php?lagerartikel_id=<?php echo $row['lagerartikel_id']; ?>'><img src="crud-icon/edit.png" title="Edit" /></a>
          </td>
