...
FROM daily_artikel
WHERE (((daily_artikel.id_artikel)=$id_artikel) AND 
(daily_artikel.date Between '$search2%' AND '$search3%' )) AND
(daily_artikel.name_lager LIKE '%$search_keyword%' or daily_artikel.name_user LIKE '%$search_keyword%' or daily_artikel.retoure LIKE '%$search_keyword%' or daily_artikel.sales LIKE '%$search_keyword%')
...
<!--
    <td>sales :
    <?php echo utf8_encode($data4["sales"]); ?></td>
-->
    </tr>
    </table>    
<table class="tbl-qa">
