...
<body>
<div style="margin:20px 0px;text-align:right;"><a href="lager.php" class="button_link">Back to List</a></div>
<div class="frm-add">
...
<form name="frmAdd" action="" method="POST">
    ...
    <div class="demo-form-row">
	  <label>Lager: </label>
	  <input type="text" name="name_lager" class="demo-form-field"  required />
  </div>
